        ...
        <View style={styles.container}>
                ...
                >
                    ...
                    <View style={{ marginTop: SIZES.radius }}>
                        <Text style={{ color: COLORS.gray }}>
                            Ski Villa propose des chambres simples avec vue sur la montagne, en face de la remontée mécanique de la station de ski.
                        </Text>
                    </View>
                </View>
            ...
            <View style={{ flex: 1.5 }}>
                ...
                <View style={{ marginTop: SIZES.padding, paddingHorizontal: SIZES.padding }}>
                    ...
                    Situé dans les Alpes, à une altitude de 1 702 mètres. Le domaine skiable est le plus grand domaine skiable du monde et est connu comme le meilleur endroit pour skier. De nombreuses autres installations, comme un centre de remise en forme, un sauna, un hammam et des restaurants étoilés.
                    </Text>
                </View>
            </View>
